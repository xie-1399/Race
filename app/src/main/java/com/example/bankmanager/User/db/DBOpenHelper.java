package com.example.bankmanager.User.db;
...
import com.example.bankmanager.User.model.User;
...
//    }
    ...
    public void onCreate(SQLiteDatabase db) {
         ...
         */
        db.execSQL("create table if not exists user (_id integer  primary key autoincrement,name  text,  password  text)"); //先执行创建表语句
